function TodoSearch() {
    return (
        <div className="flex justify-between items-center bg-slate-100 border rounded-lg px-2">
            <input className='appearance-none bg-slate-100 text-4xl' placeholder="Search..."></input>
